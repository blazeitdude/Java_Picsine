...
public class Program {
	public static void main(String[] args) {
		...
		service.removeTransactionFromUser(p1.getID(), service.retrieveUserTransaction(p1).toArray()[transactionIndex].getID());
		transactionIndex = 0;
		service.removeTransactionFromUser(p3.getID(), service.retrieveUserTransaction(p3).toArray()[transactionIndex].getID());
